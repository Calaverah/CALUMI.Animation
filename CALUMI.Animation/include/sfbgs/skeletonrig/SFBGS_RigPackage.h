...
namespace CALUMI::SFBGS
{
	...
	public:
		...
		/**
			 ...
			 * @return
			 */
		static bool CreateNewSFBGSRigPackage(const UNIV::SkeletonRig& rig, bool overwrite = true);
		/**
			 * @brief Method for removing a Starfield Rig Package from a UNIV Skeleton Rig
			 * @param rig
			 * @return
			 */
		static bool RemoveSFBGSRigPackage(const UNIV::SkeletonRig& rig);
	...
	/**
			 ...
			 * @return Whether the operation was successful
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_AddPackageToSkeletonRigC(const UNIV::SkeletonRig* rig, Utilities::StringContainer* errorMessage, bool overwrite);
	/**
			 * @brief
			 * @param rig UNIV Rig
			 * @param errorMessage *optional* error message container for returning error statements
			 * @return Whether the operation was successful
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_RemoveRigPackageFromSkeletonRigC(const UNIV::SkeletonRig* rig, Utilities::StringContainer* errorMessage);
	...
	/**
			 ...
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_BoneIsMappedC(const UNIV::SkeletonRig* rig, const char* boneName);
	/**
			 * @brief
			 * @param rig UNIV Rig
			 ...
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_KeyIsMappedC(const UNIV::SkeletonRig* rig, uint8_t key);
	...
	/**
			 ...
			 * @return Whether the operation was successful
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_AddBoneNameToMapC(const UNIV::SkeletonRig* rig, uint8_t key, const char* boneName, Utilities::StringContainer* errorMessage, bool overwrite);
	/**
			 * @brief
			 * @param rig UNIV Rig
			 * @param key uint8_t form of the BoneMapKey
			 ...
			 * @return Whether the operation was successful
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_AddBoneToMapC(const UNIV::SkeletonRig* rig, uint8_t key, const UNIV::SkeletonBone* bone, Utilities::StringContainer* errorMessage, bool overwrite);
	...
	/**
			 ...
			 * @return Whether the operation was successful
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_RemoveBoneFromMapUsingKeyC(const UNIV::SkeletonRig* rig, uint8_t key);
	/**
			 ...
			 * @return Whether the operation was successful
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_RemoveBoneFromMapUsingNameC(const UNIV::SkeletonRig* rig, const char* boneName);
	...
	/**
			 ...
			 */
	CALUMIANIMATION_API uint8_t SFBGSRigPackage_GetBoneKeyC(const UNIV::SkeletonRig* rig, const char* boneName);
	/**
			 ...
			 * @return
			 */
	CALUMIANIMATION_API const char* SFBGSRigPackage_GetBoneNameFromKeyC(const UNIV::SkeletonRig* rig, uint8_t key);
	...
	/**
			 ...
			 * @return Whether the operation was successful
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_SetMannequinC(const UNIV::SkeletonRig* rig, bool isMannequin);
	/**
			 * @brief Returns if the rig is set to process as a mannequin when exporting as a Starfield skeleton.rig
			 * @param rig UNIV Rig
			 * @return
			 */
	CALUMIANIMATION_API bool SFBGSRigPackage_IsMannequinC(const UNIV::SkeletonRig* rig);
	/**
	...
	/**
			 ...
			 * @param rig UNIV Rig
			 */
	CALUMIANIMATION_API void SFBGSRigPackage_SetPrecisionToDefaultC(const UNIV::SkeletonRig* rig);
	/**
			 * @brief Sets the rig to process all relative translations with the *1st Person* precision set
			 * @param rig UNIV Rig
			 */
	CALUMIANIMATION_API void SFBGSRigPackage_SetPrecisionToFirstPersonC(const UNIV::SkeletonRig* rig);
	/**
			 * @brief Sets the rig to process all relative translations with the *Ship* precision set
			 * @param rig UNIV Rig
			 */
	CALUMIANIMATION_API void SFBGSRigPackage_SetPrecisionToShipValuesC(const UNIV::SkeletonRig* rig);
	/**
			 ...
			 */
	CALUMIANIMATION_API void SFBGSRigPackage_SetPrecisionToCustomC(const UNIV::SkeletonRig* rig, float custom1, float custom2);
	...
	/**
			 ...
			 */
	CALUMIANIMATION_API const char* SFBGSRigPackage_GetPrecisionType(const UNIV::SkeletonRig* rig);
	/**
			 * @brief The high precision value used by this rig for compressing into the Starfield format
			 * @param rig UNIV Rig
			 * @return
			 */
	CALUMIANIMATION_API float SFBGSRigPackage_GetHighPrecisionValueC(const UNIV::SkeletonRig* rig);
	/**
			 * @brief The low precision value used by this rig for compressing into the Starfield format
			 * @param rig UNIV Rig
			 * @return
			 */
	CALUMIANIMATION_API float SFBGSRigPackage_GetLowPrecisionValueC(const UNIV::SkeletonRig* rig);
