...
namespace CALUMI::UNIV
{
	...
	extern  "C" {
		 ...
		 * @param boneType unsigned int form of the bone type enum, see @ref CALUMI::UNIV::BoneTypeProperty
		 * "Bone Type"
		 ...
		 * @param source
		 * @param typeAsInteger Int form of UNIV::BoneTypeProperty::BoneType
